...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'custom-radial': 'radial-gradient(circle, #390047, #000000)',
        'main-bg': "url('/src/assets/website banner bg.png')",
        'thumbnail': "url('/src/assets/Group\ 6.png')"
      },
      boxShadow: {
        'custom': '0px 5px 32.3px 6px #760b97', // x-offset 0, y-offset 3, blur 32.3, spread 6
        'custom2': '0px 2px 42.3px 1px #760b97',
